# projectEntity-service

This projectEntity uses Quarkus, the Supersonic Subatomic Java Framework.
...
You can then execute your native executable with: `./target/projectEntity-service-1.0-SNAPSHOT-runner`
